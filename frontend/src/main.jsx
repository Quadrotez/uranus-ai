...
function App() {
  ...
  async function loadModels(providerId) {
    try {
      ...
      setModels(items || []);
      setModelsByProvider((current) => ({ ...current, [providerId]: items || [] }));
  ...
  return (
    <div className="app-shell">
      ...
      <main className="main-panel">
        ...
        {view === "admin" && <AdminView providers={providers} modelsByProvider={modelsByProvider} onSelectModel={(providerId, modelId) => { setSelectedModel(`${providerId}:${modelId}`); navigate("chat"); showNotice(`Выбрана модель ${modelId}`); }} saveProvider={saveProvider} clearProviderProxy={clearProviderProxy} testProvider={testProvider} loadModels={loadModels} settings={settings} saveSetting={saveSetting} skills={skills} toggleSkill={toggleSkill} />}
      </main>
...
function AdminView({ providers, modelsByProvider, onSelectModel, saveProvider, clearProviderProxy, testProvider, loadModels, settings, saveSetting, skills, toggleSkill }) {

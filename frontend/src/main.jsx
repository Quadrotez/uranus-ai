  ...
  return (
    <div className="app-shell">
      ...
      <main className="main-panel">
        ...
        {view === "admin" && <AdminView providers={providers} saveProvider={saveProvider} testProvider={testProvider} loadModels={loadModels} settings={settings} saveSetting={saveSetting} skills={skills} toggleSkill={toggleSkill} />}
      </main>
...
function AdminView({ providers, saveProvider, testProvider, loadModels, settings, saveSetting, skills, toggleSkill }) {
